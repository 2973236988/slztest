...
<body>
<div class="container">
    <h3 style="text-align: center">石榴仔成员信息列表</h3>
    ...
    --%>
    <form action="${pageContext.request.contextPath}/user/delUser" method="post" id="form">
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${pb.list}" var="user" varStatus="s">
                <tr>
                    ...
                    <td>${user.category}</td>
                    <td>
                        <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/user/findUser?id=${user.uid}">修改</a>&nbsp;
